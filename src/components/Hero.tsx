        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-16">
            <button
              ...
              className="w-full sm:w-auto flex items-center justify-center space-x-2 px-8 py-4 bg-blue-700 text-white rounded-xl hover:bg-blue-800 btn-hover focus-ring shadow-lg"
            >
            ...
            <button 
              onClick={onGetStarted}
              className="w-full sm:w-auto px-8 py-4 border-2 border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 btn-hover focus-ring shadow-lg"
            >
              <span className="font-semibold">Explore Campus Map</span>
            </button>
          </div>
          ...
          <div className="cards-grid max-w-6xl mx-auto mb-20">
            <div className="group bg-white p-8 rounded-2xl shadow-lg border border-gray-100 card-hover focus-ring" tabIndex={0}>
              ...
              <button 
                onClick={onGetStarted}
                className="text-blue-700 hover:text-blue-800 font-medium flex items-center space-x-1 opacity-0 group-hover:opacity-100 transition-all duration-300 focus-ring rounded"
              >
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-lg border border-gray-100 card-hover focus-ring" tabIndex={0}>
              ...
              <button 
                onClick={onGetStarted}
                className="text-emerald-600 hover:text-emerald-700 font-medium flex items-center space-x-1 opacity-0 group-hover:opacity-100 transition-all duration-300 focus-ring rounded"
              >
                <span>Learn More</span>
                <ArrowRight className="h-4 w-4" />
              </button>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-lg border border-gray-100 card-hover focus-ring" tabIndex={0}>
              ...
              <button 
                onClick={onGetStarted}
                className="text-purple-600 hover:text-purple-700 font-medium flex items-center space-x-1 opacity-0 group-hover:opacity-100 transition-all duration-300 focus-ring rounded"
              >
                <span>Learn More</span>
                <ArrowRight className="h-4 w-4" />
              </button>
